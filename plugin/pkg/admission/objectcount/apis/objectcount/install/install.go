...
import (
	...
	internalapi "k8s.io/kubernetes/plugin/pkg/admission/objectcount/apis/objectcount"
	versionedapi "k8s.io/kubernetes/plugin/pkg/admission/objectcount/apis/objectcount/v1alpha1"
)
